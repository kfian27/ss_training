...
<script type="text/javascript">
	$(document).ready(function() {
        var element = document.getElementById("Form_PropertySearchForm_ArrivalDate");
    	element.classList.add("form-control");
    	var element1 = document.getElementById("Form_PropertySearchForm_Keywords");
    	element1.classList.add("form-control");
      });
</script>
p<!-- END CONTENT WRAPPER -->