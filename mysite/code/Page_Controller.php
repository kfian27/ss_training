...
class Page_Controller extends ContentController
{
    ...
    public function init()
    {
        ...
        Requirements::css("cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css");
        ...
        Requirements::javascript("cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js");
    }
}
